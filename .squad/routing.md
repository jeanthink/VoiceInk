...
|-----------|---------|----------|
| Architecture, coordination, PRs | Holden | — |
| VoiceInkCore package extraction | Naomi | — |
| Avalonia shell, C# adapters | Amos | — |
| VoiceInkService HTTP bridge | Bobbie | — |
| macOS app rewire, adapter interfaces | Drummer | — |
