...
public struct TemplatePrompt: Identifiable {
    public let id: UUID
    ...
    public init(id: UUID = UUID(), title: String, promptText: String, icon: PromptIcon, description: String) {
        self.id = id
        self.title = title
    ...
    public func toCustomPrompt() -> CustomPrompt {
        CustomPrompt(
            id: UUID(),
            title: title,
...
public enum PromptTemplates {
    public static var all: [TemplatePrompt] {
        createTemplatePrompts()
    }
    
    public static func createTemplatePrompts() -> [TemplatePrompt] {
        [
            TemplatePrompt(
                id: UUID(),
